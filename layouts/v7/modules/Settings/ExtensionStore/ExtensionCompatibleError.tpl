							...
							<tbody>
								<tr>
									...
									<td width="80%" style="border-bottom: 1px solid rgb(204, 204, 204);">
										<span class="genHeaderSmall"><b>{vtranslate($EXTENSION_LABEL, $QUALIFIED_MODULE)}</b> {ucfirst(strtolower(vtranslate('LBL_EXTENSION_NOT_COMPITABLE', $QUALIFIED_MODULE)))}</span>
									</td>
								</tr>
								<tr>
