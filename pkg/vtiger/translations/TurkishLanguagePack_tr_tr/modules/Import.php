...
$languageStrings = array(
	...
	'LBL_CHARACTER_ENCODING'       => 'Karakter Şifreleme'          ,
	'LBL_DELIMITER'                => 'Ayraç:'                     ,
	...
	'LBL_SPECIFY_MERGE_TYPE'       => 'Tekrar eden kayıtların nasıl işleneceğini seçin',
	'LBL_SELECT_MERGE_FIELDS'      => 'Tekrar eden kayıtları bulmak için eşleşecek alanları seçin',
	'LBL_AVAILABLE_FIELDS'         => 'Mevcut Alanlar'             ,
	'LBL_SELECTED_FIELDS'          => 'Seçilmiş alanlar'       ,
	'LBL_NEXT_BUTTON_LABEL'        => 'Sonraki'                     ,
	'LBL_IMPORT_STEP_4'            => 'Step 4'                      ,
	'LBL_IMPORT_STEP_4_DESCRIPTION' => 'Map the Columns to Module Fields',
	'LBL_FILE_COLUMN_HEADER'       => 'Başlık'                      ,
	'LBL_ROW_1'                    => 'Satır 1'                       ,
	'LBL_CRM_FIELDS'               => 'CRM Alanları'                  ,
	'LBL_DEFAULT_VALUE'            => 'Varsayılan Değer'               ,
	'LBL_SAVE_AS_CUSTOM_MAPPING'   => 'Özelleştirilmiş Haritalama Olarak Kaydet'     ,
	...
	'LBL_SELECT_SAVED_MAPPING'     => 'Kaydedilmiş Haritalama Seç'        ,
  ...
  'LBL_USE_SAVED_MAPS' => 'Kaydedilmiş Haritalamaları Kullan',
  'LBL_IMPORT_MAP_FIELDS' => 'CRM alanları sütunlarla göster ',
  'LBL_UPLOAD_CSV' => 'CSV Dosyası Yükle',
  'LBL_UPLOAD_VCF' => 'VCF Dosya Upload',
  'LBL_DUPLICATE_HANDLING' => 'Tekrarın Önlenmesi ',
  ...
  'LBL_DUPLICATE_RECORD_HANDLING' => 'Tekrar Eden Kayıtların İşlenmesi',
  ...
  'comma' => 'Virgül ( , )',
    ...
    'Pipe' => 'Düz Çizgi ( | )',
    'Caret' => 'Şapka ( ^ )',
    'LBL_FIELD_MAPPING'=>'Alan Haritalaması',
    'Skip' => 'Atla',
    'Overwrite' => 'Üstüne Yaz',
    'Merge' => 'Birleştir',
    'Skip this step' => 'Bu Adımı Atla',
    'LBL_IMPORT_MAP_FIELDS'=>'CRM Alanları İçin Kolonları Haritala',
